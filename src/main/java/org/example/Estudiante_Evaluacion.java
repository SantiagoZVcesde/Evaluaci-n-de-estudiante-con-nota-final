...
public class Estudiante_Evaluacion {
    public static void main(String[] args) {
        ...
        Nota_Mas_Alta = Math.max(Math.max(Nota_uno, Nota_dos), Math.max(Nota_tres, Nota_cuatro));
        Nota_Mas_Baja = Math.min(Math.min(Nota_uno, Nota_dos), Math.min(Nota_tres, Nota_cuatro));
